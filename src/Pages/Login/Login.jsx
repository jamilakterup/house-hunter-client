            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card-body py-2">
                    ...
                    <div className="form-control mt-6">        
                        <button type="submit" className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-violet-500 rounded-xl group">
                        <span className="absolute top-0 right-0 inline-block w-4 h-4 transition-all duration-500 ease-in-out bg-violet-700 rounded group-hover:-mr-4 group-hover:-mt-4">
                        <span className="absolute top-0 right-0 w-5 h-5 rotate-45 translate-x-1/2 -translate-y-1/2 bg-white"></span>
                        </span>
                        <span className="absolute bottom-0 left-0 w-full h-full transition-all duration-500 ease-in-out delay-200 -translate-x-full translate-y-full bg-violet-600 rounded-2xl group-hover:mb-12 group-hover:translate-x-0"></span>
                    ...
                    <p className="label-text-alt mb-5">New to account? <Link className=" link link-hover text-violet-600" to='/register'>Register</Link></p>
                </form>
            </div>
        </div>
    );

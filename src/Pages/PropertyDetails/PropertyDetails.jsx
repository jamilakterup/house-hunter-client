            ...
            <div className="container mx-auto min-h-[800px] mb-14">
                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    ...
                    <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
                        ...
                        <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-10 text-sm' type="text" placeholder='Name*'/>    
                        <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-10 text-sm' type="text" placeholder='Email*'/>    
                        <input className='border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-10 text-sm' type="text" placeholder='Phone*'/>    
                        <textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message*' defaultValue="Hello, I'm interested in this add"></textarea>
                        <div className='flex gap-x-5'>
                            ...
                            <span className="w-48 h-48 rounded rotate-[-40deg] bg-violet-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
